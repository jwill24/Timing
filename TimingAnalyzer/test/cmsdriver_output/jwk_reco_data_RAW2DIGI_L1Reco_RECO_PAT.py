...
# with command line options: jwk_reco_data -s RAW2DIGI,L1Reco,RECO,PAT --datatier RECO,MINIAOD --conditions 101X_dataRun2_Prompt_v11 --eventcontent RECO,MINIAOD --era Run2_2018 --data --runUnscheduled -n 100 --no_exec
