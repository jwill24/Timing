...
## outputFile Name
options.register('outputFileName','ku_kurh2_twotier_run18D_dispho.root',VarParsing.multiplicity.singleton,VarParsing.varType.string,'output file name created by cmsRun');
