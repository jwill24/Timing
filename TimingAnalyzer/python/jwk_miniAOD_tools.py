...
#print( ">>>>>>>>>>>> jwk miniAOD_tools accessed" )

def miniAOD_customizeCommon(process):
#    print( ">>>>>>>>>>>> jwk miniAOD_tools customizeCommon " )
...
#    makeInputForPUPPIIsolationMuon(process)
    ...
    #1from Configuration.Eras.Modifier_run2_miniAOD_devel_cff import run2_miniAOD_devel
