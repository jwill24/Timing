...
kuKsEcalMultiFitUncalibRecHit = ecalMultiFitUncalibRecHit.clone(
        EBhitCollection = cms.string("kuKsEcalUncalibRecHitsEB"),
        EEhitCollection = cms.string('kuKsEcalUncalibRecHitsEE'),
        algoPSet = cms.PSet(
              # for multifit method
...
kuWeiEcalMultiFitUncalibRecHit = ecalMultiFitUncalibRecHit.clone(
        EBhitCollection = cms.string("kuWeiEcalUncalibRecHitsEB"),
        EEhitCollection = cms.string('kuWeiEcalUncalibRecHitsEE'),
        algoPSet = cms.PSet(
              # for multifit method
              EcalPulseShapeParameters = cms.PSet( ecal_pulse_shape_parameters ),
              activeBXs = cms.vint32(-5,-4,-3,-2,-1,0,1,2,3,4),
...
kuWeiNotEcalMultiFitUncalibRecHit = ecalMultiFitUncalibRecHit.clone(
        EBhitCollection = cms.string("kuWeiNotEcalUncalibRecHitsEB"),
        EEhitCollection = cms.string('kuWeiNotEcalUncalibRecHitsEE'),
        algoPSet = cms.PSet(
              # for multifit method
              EcalPulseShapeParameters = cms.PSet( ecal_pulse_shape_parameters ),
              activeBXs = cms.vint32(-5,-4,-3,-2,-1,0,1,2,3,4),
