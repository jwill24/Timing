...
skiminfile='dispho_2t_eg2018B_local_icv2_i25_e5e3.root'
...
preplotoutfile='dispho_2t_eg2018B_local_ic_v2_i25_preplot.root'
...
caliinfile='dispho_2t_eg2018B_local_icv2_i25.root'
...
skimsp='root -b -q -l wc_runKUSkimmer.C\(\\"'
...
#        cmdskim=skimsp+indir+qc+skimoutdir+qc+skiminfile+qc+skim_cf+end_skim
	print(cmdskim)
	os.system(cmdskim)
...
def do_intercali():
	...
	cmdintercali=dointercali+skimoutdir+skiminfile+end_skim
        print(cmdintercali)
