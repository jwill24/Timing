...
// Wed May  8 22:03:22 2019 by ROOT version 6.12/07
// from TTree disphotree/disphotree
// found on file: /home/t3-ku/jaking/trees/ecal/trial_run18A_dispho.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<unsigned int> *uRhId;
   vector<float>   *amplitude;
   vector<float>   *amplitudeError;
   ...
   vector<float>   *ootA7;
   vector<float>   *ootA8;
   vector<float>   *jitterError;
   vector<bool>    *isSaturated;
   vector<bool>    *isJitterValid;
   vector<bool>    *isJitterErrorValid;
   Int_t           ndigis;
   vector<unsigned int> *digiID;
   Float_t         digiData;
   Int_t           nphotons;
   Float_t         phoE_0;
   Float_t         phopt_0;
   ...
   TBranch        *b_ootA7;   //!
   TBranch        *b_ootA8;   //!
   TBranch        *b_jitterError;   //!
   TBranch        *b_isSaturated;   //!
   TBranch        *b_isJitterValid;   //!
   TBranch        *b_isJitterErrorValid;   //!
   TBranch        *b_ndigis;   //!
   TBranch        *b_digiID;   //!
   TBranch        *b_digiData;   //!
   TBranch        *b_nphotons;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/t3-ku/jaking/trees/ecal/trial_run18A_dispho.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/t3-ku/jaking/trees/ecal/trial_run18A_dispho.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/home/t3-ku/jaking/trees/ecal/trial_run18A_dispho.root:/dispho");
...
void disphotree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("uRhId", &uRhId, &b_uRhId);
   fChain->SetBranchAddress("amplitude", &amplitude, &b_amplitude);
   fChain->SetBranchAddress("amplitudeError", &amplitudeError, &b_amplitudeError);
   fChain->SetBranchAddress("pedestal", &pedestal, &b_pedestal);
   fChain->SetBranchAddress("jitter", &jitter, &b_jitter);
   fChain->SetBranchAddress("chi2", &chi2, &b_chi2);
   fChain->SetBranchAddress("ootA0", &ootA0, &b_ootA0);
   fChain->SetBranchAddress("ootA1", &ootA1, &b_ootA1);
   fChain->SetBranchAddress("ootA2", &ootA2, &b_ootA2);
   fChain->SetBranchAddress("ootA3", &ootA3, &b_ootA3);
   fChain->SetBranchAddress("ootA4", &ootA4, &b_ootA4);
   fChain->SetBranchAddress("ootA5", &ootA5, &b_ootA5);
   fChain->SetBranchAddress("ootA6", &ootA6, &b_ootA6);
   fChain->SetBranchAddress("ootA7", &ootA7, &b_ootA7);
   fChain->SetBranchAddress("ootA8", &ootA8, &b_ootA8);
   fChain->SetBranchAddress("jitterError", &jitterError, &b_jitterError);
   fChain->SetBranchAddress("isSaturated", &isSaturated, &b_isSaturated);
   fChain->SetBranchAddress("isJitterValid", &isJitterValid, &b_isJitterValid);
   fChain->SetBranchAddress("isJitterErrorValid", &isJitterErrorValid, &b_isJitterErrorValid);
   fChain->SetBranchAddress("ndigis", &ndigis, &b_ndigis);
   fChain->SetBranchAddress("digiID", &digiID, &b_digiID);
   fChain->SetBranchAddress("digiData", &digiData, &b_digiData);
   ...
   fChain->SetBranchAddress("phodz_0", &phodz_0, &b_phodz_0);
   ...
   fChain->SetBranchAddress("phodz_1", &phodz_1, &b_phodz_1);
   ...
   fChain->SetBranchAddress("phodz_2", &phodz_2, &b_phodz_2);
   ...
   fChain->SetBranchAddress("phodz_3", &phodz_3, &b_phodz_3);
