...
void wc_ku_Preplot( string infilename, string outfilename ){
	...
	int adjust = 100.0;
		...
		//}
                ...
                phoseedtimeWootStcCaliE5_0 = epmapwte5->GetBinContent( phoseedI2_0, phoseedI1_0 ) - adjust;
                ...
                phoseedtimeWootStcCaliE5_0 = emmapwte5->GetBinContent( phoseedI2_0, phoseedI1_0 ) - adjust;
	...
	if ( phoseedEcal_1 == ECAL::EB ){
                ...
                phoseedtimeWootStcCaliE5_1 = epmapwte5->GetBinContent( phoseedI2_1 + bin_offset, phoseedI1_1 ) - adjust;
                ...
                phoseedtimeWootStcCaliE5_1 = emmapwte5->GetBinContent( phoseedI2_1 + bin_offset, phoseedI1_1 ) - adjust;
